            ...
            <table class="table table-striped " style="margin-top: 55px;margin-left: 215px;">
             ...
             @foreach($data as $value)
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-right" style="display:flex;padding-left:75px">
                      </a>
                          <form action="{{route('user.edit')}}" method="get" enctype="multipart/form">
									@csrf
                          ...
                          <form style="margin-left: 20px;"  onclick="return confirm('Bạn có chắc chắn muốn xoá !!')" action="{{route('user.delete')}}" method="get" enctype="multipart/form">
									@csrf
