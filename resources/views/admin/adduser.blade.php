...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            @endif
            <form action="{{ route('adduser.add') }}" method="post" enctype="multipart/form-data" style="margin-left: 240px;width: 100%;">
 @csrf
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" id="inputPrice" class="form-control" name="name">
            </div>
            <div class="form-group">
