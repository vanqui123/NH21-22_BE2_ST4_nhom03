...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        @endif
        <a href="{{route('admin.addprotype')}}" class="btn btn-primary" style="position: absolute;top: 65px;left: 220px;">Thêm loại sản phẩm</a>
        <table class="table table-bordered " style="margin-top: 130px;margin-left: 215px;">
            <thead>
                <tr>
                ...
                <tr>
                    ...
                    <td class="project-actions text-center">
                        ...
                        <form action="{{route('admin.editProtype',['id'=>$value->type_id])}}" method="get" enctype="multipart/form">
                            ...
                            <input type="hidden" name="id" value="{{$value->type_id}}" />
                        </form>
                    </td>
                    <td class="project-actions text-center">
                        <form onclick="return confirm('Bạn có chắc chắn muốn xoá !!')" action="{{route('admin.deleteProtype',['id'=>$value->type_id])}}" method="get" enctype="multipart/form">
                            @csrf
