...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        @endif
        <form action="{{route('admin.postEditProtype')}}" method="post" enctype="multipart/form-data" style="margin-left: 240px;width: 100%;margin-top: 120px">
            @csrf
            <section class="content">
                <div class="row">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputName" class="form-control" name="type_name" value="{{old('type_name') ?? $protypeDetail->type_name}}">
                                    @error('name')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a href="{{route('admin.protypeadmin')}}" class="btn btn-warning">Quay lại</a>
