...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        @endif
        <form action="{{route('admin.postEdit')}}" method="post" enctype="multipart/form-data" style="margin-left: 240px;width: 100%;margin-top: 120px">
            @csrf
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputName" class="form-control" name="product_name" value="{{old('product_name') ?? $productDetail->name}}">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="quantity" name="quantity" value="{{old('quantity') ?? $productDetail->product_quanity}}" min="1" max="500">
                                </div>
                                <div class="form-group">
                                    <label for="inputDescription">Description</label>
                                    <textarea id="inputDescription" class="form-control" rows="4" name="product_description">{{old('product_description') ?? $productDetail->description}}</textarea>
                                    @error('description')
                                    <span style="color:red;">
                                        {{$message}}
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputPrice" class="form-control" name="product_price" value="{{old('price')?? $productDetail->price}}">
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="inputClientCompany">Discount</label>
                                    <input type="text" id="inputDiscount" class="form-control" name="discount" value="{{old('discount')?? $productDetail->discount}}">
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="start">Date Expire:</label>
                                    <input type="date" id="start" name="date_expire" value="{{$productDetail->date_expire}}" min="{{date('Y-m-d H:i:s')}}" max="2050-12-18">
                                </div>
                                <div class="form-group">
