...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            @endif
            <form action="{{ route('useredit.edit') }}" method="post" enctype="multipart/form-data" style="margin-left: 240px;width: 100%;">
 @csrf
        ...
        <div class="card card-primary">
          ...
          @foreach($useredit as $user)
            <div class="form-group">
              ...
              <input type="hidden" id="inputPrice" class="form-control" name="id" value="{{$user->id}}">

              <input type="text" placeholder="{{$user->name}}" id="inputPrice" class="form-control" name="name">
            </div>
            <div class="form-group">
            <label for="inputClientCompany">Email</label>
              <input type="text" id="inputPrice" class="form-control" name="email">
            </div>
            <div class="form-group">
            <label for="inputClientCompany">Password</label>
              <input type="text" id="inputPrice" class="form-control" name="password">
            </div>
          
            <select style="margin-top:10px;" class="form-control" name="role" id="">
