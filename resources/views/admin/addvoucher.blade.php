...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            @endif
            <form action="{{ route('voucher.add') }}" method="post" enctype="multipart/form-data" style="margin-left: 240px;width: 100%;">
 @csrf
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="form-group">
              <label for="inputClientCompany">Voucher_name</label>
              <input type="text" id="inputPrice" class="form-control" name="voucher_name">
            </div>
            <div class="form-group">
              <label for="inputDescription">Voucher_price</label>
              <input id="inputDescription" class="form-control" rows="4" name="voucher_price">
            </div>
